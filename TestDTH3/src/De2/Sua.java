...
public class Sua extends javax.swing.JDialog {
    ...
    public Sua(java.awt.Frame parent, boolean modal) {
        ...
        jTextField4.setText(s.getChuyennganh());
        jTextField5.setText(s.getNam()+"");
        jTextField6.setText(s.getSoluong()+"");
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "KHTN", "VHNT", "DTVT", "CNTT" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Sach s = new Sach(jTextField1.getText(), jTextField2.getText(), jTextField3.getText(), 
