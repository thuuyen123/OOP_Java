...
public class Q4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nhap 1 day so:");

        jTextField1.setText("12 -9 56 0");

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jScrollPane1.setViewportView(jTextArea1);

        jButton1.setText("Send To");
    ...
    public void setTextArea(List<String> names,String op){
        jTextArea1.setText("Thuc hien boi:\n");
        for(String i:names)
            jTextArea1.append(i+"\n");
