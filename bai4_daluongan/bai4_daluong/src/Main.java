...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        int numRobots = 2;
        int maxMove = 30;
        List<Robot_Thread> robotThreadList = new ArrayList<>();
        for (int i = 0; i < numRobots; i++) {
            robotThreadList.add(new Robot_Thread(i, 0, new Robot(), maxMove));
        }
        ...
        while (running) {
            for (Robot_Thread robot_thread : robotThreadList) {
